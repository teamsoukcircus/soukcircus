...
{ 
  ...
  if ( user != null && user.FullName != null && user.FullName.trim() != "")
  {
    //let splitted = utils_splitString(user.FullName," ");
      ...
      //page.actionOrders           = utils_getUrl()  + "?actionId=actionOrders"; passée dans shipping
      //page.actionCommandesSouk    = utils_getUrl()  + "?actionId=actionCommandesSouk"; passée dans la page stock-html.html
