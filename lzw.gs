...
function test()
{
  let str='TOBEORNOTsdkjhflkjsdhfjkhasjkdhflkajhsdfkljahsjdklhfjksTOBEORNOTTOBEORTOBEORNOTTOBEORNOTTOBEORTOBEORNOTTOBEORNOTTOBEORTOBEORNOTkwqjlehfkqjhwerjklqhwerkljhq  kjewhrkjlq  hwerkjlhqwejklrhqjlkwherjklqhwjkelrhqkljehwrlqTOBEORTOBEORNOT';

  let comp = LZW.compress(str);
  let decomp = LZW.decompress(comp);
  Logger.log(str.length + "," +comp.length);
  Logger.log(`${comp}`)
  Logger.log(`${decomp}`);
