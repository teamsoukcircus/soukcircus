...
function test_getEmailForOverallFeedBack()
{
  let e = getEmailForOverallFeedBack("Simon Oldani","en",['item 1', 'item 3']);
  //mailing_sendMail(e.subject,e.body,"oldanisim@gmail.com");
  mailing_sendMail(e.subject,e.body,"oldanisim@gmail.com");
}

function getEmailForOverallFeedBack(customerName,language,listOfItemBought)
{
      ...
      switch(language)
      {
        case COUNTRIES_LANG.DE[1]:
          subject = LanguageApp.translate(T_OVERALL, 'en', 'de');
        ...
        case COUNTRIES_LANG.FR[1]:
          subject = LanguageApp.translate(T_OVERALL, 'en', 'fr');
        ...
        case COUNTRIES_LANG.NL[1]:
          subject = LanguageApp.translate(T_OVERALL, 'en', 'nl');
          dearCustomer = LanguageApp.translate(T_DEAR, 'en', 'nl') + "&nbsp" + customerName;
          
          introText1 = LanguageApp.translate(T_OPINION_MATTER, 'en', 'nl') ;
      ...
      let page = HtmlService.createTemplateFromFile("feedbackOverall-html");
